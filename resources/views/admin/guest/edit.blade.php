    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-xl mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="p-8">
                    <h1 class="text-2xl font-serif font-bold text-slate-800 mb-1">Editar Convidado</h1>
                    <p class="text-sm text-slate-500 mb-8 italic">Alterando dados de: {{ $guest->name }}</p>
                    ...
                    <form action="{{ route('guests.update', $guest->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_guests" value="{{ old('max_guests', $guest->max_guests) }}" min="1" required
                                       class="w-full border-slate-200 rounded-xl focus:border-slate-900 focus:ring-slate-900 text-slate-700">
                            </div>
                        </div>
